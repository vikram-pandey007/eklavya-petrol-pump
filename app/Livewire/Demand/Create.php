...
class Create extends Component
{
    ...
    public function mount()
    {
        ...
        $segmentsData = [
            ...
            'item_2' => __('messages.demand.breadcrumb.create'),
        ];
    ...
    public function store()
    {
        ...
        session()->flash('success', __('messages.demand.messages.success'));
    ...
    {
        return view('livewire.demand.create')->title(__('messages.meta_title.create_demand'));
    }
